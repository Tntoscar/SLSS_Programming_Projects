...
def main() -> None:
    ...
    while not done:
        ...
        pygame.draw.circle(screen, BLUE, (500, 200), 75)
        pygame.draw.circle(screen, BLUE, (700, 200), 75)
        pygame.draw.circle(screen, BLUE, (600, 250), 75)
        pygame.draw.circle(screen, BLUE, (600, 270), 75)
        pygame.draw.circle(screen, BLUE, (600, 290), 75)
        # Update the screen
        pygame.display.flip()
